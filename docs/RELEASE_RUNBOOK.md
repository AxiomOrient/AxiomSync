...
## Preflight
- `README.md`, `docs/`, `extensions/chatgpt/README.md`를 기준 문서로 사용한다.
...
## Companion Asset Check
- if shipping ChatGPT capture:
  - load `extensions/chatgpt`
  - run `cargo run -p axiomsync -- connector serve chatgpt --addr 127.0.0.1:4402`
  - confirm the extension can post local events to `http://127.0.0.1:4402/`
