...
fn commit_extracts_six_categories_and_reindexes_immediately() {
    ...
    session
        .add_message("user", "This project repository is AxiomNexus")
...
fn extract_memories_fixture_entities_category() {
    let categories = fixture_categories("user", "This project repository is AxiomNexus.");
