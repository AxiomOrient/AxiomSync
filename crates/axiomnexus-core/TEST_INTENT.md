# axiomnexus-core Test Intent (Pseudo Code)

이 문서는 `axiomnexus-core` 핵심 기능의 테스트 의도를 pseudo code 수준으로 명시한다.
...
- `crates/axiomnexus-core/src/client/tests/initialization_lifecycle.rs`
...
- `crates/axiomnexus-core/src/fs.rs`
...
- `crates/axiomnexus-core/src/client/tests/core_editor_retrieval.rs`
- `crates/axiomnexus-core/src/client/indexing_service.rs`
...
- `crates/axiomnexus-core/src/client/indexing_service.rs`
- `crates/axiomnexus-core/src/pack.rs`
- `crates/axiomnexus-core/src/client/release/benchmark_service.rs`
...
- `crates/axiomnexus-core/src/client/tests/queue_reconcile_lifecycle.rs`
- `crates/axiomnexus-core/src/state/queue.rs`
...
Given workspace missing axiomnexus-core contract probe target
...
- `crates/axiomnexus-core/src/client/tests/release_contract_pack_tracemetrics.rs`
- `crates/axiomnexus-core/src/release_gate.rs`
...
- `crates/axiomnexus-core/src/embedding.rs`
